...
# Возьмите свой путь
smileapi = cdll.LoadLibrary('D:/diploma/opensmile/build/progsrc/smileapi/Release/SMILEapi.dll')
...
class OpenSMILE(object):
    ...
    def initialize(self, config_file: str, options: Dict[str, Any]=None, loglevel: int=2, debug: bool=False,
        ...
        self._check_smile_result(smileapi.smile_initialize(self._smileobj, bytes(config_file, "ascii"), len(options), options_char_arr, loglevel, 1, 1, log_file))
